...
def parse_args():
    ...
    parser.add_argument('--rom_path', default='../../z-machine-games-master/jericho-game-suite/zork1.z5')
    ...
    parser.add_argument('--eval_freq', default=1000, type=int) # started at 5000
    ...
    parser.add_argument('--walkthrough_filename', default="./zork1_swt.p")
    parser.add_argument('--use_walkthrough', action='store_true', default=False)
...
def main():
    ...
    envs = VecEnv(args.num_envs, env, wt)
